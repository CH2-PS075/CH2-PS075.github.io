                ...
                >
                    <ul className="flex flex-col p-4 mt-4 md:flex-row md:space-x-10 md:mt-0 md:border-0">
                        ...
                        <motion.button
                            variants={itemVariants}
                            transition={{ duration: 0.5 }}
                            onClick={() => window.open("https://drive.google.com/drive/folders/13BFSeNO4CUe_In3Sju6gnB2czvaG2Ep3?usp=sharing", "_blank")}
                            className="relative border-2 border-carrot text-carrot rounded-md bg-transparent px-3 py-1 font-bold text- transition-colors before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-carrot before:transition-transform before:duration-300 before:content-[''] hover:text-white hover:fon-bold before:hover:scale-x-100"
                        >
                            Download
                        </motion.button>
                    </ul>
